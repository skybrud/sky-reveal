(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("sky-reveal", [], factory);
	else if(typeof exports === 'object')
		exports["sky-reveal"] = factory();
	else
		root["SkyReveal"] = factory();
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return trackList; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__events__ = __webpack_require__(28);
...
const container = {
	element: __WEBPACK_IMPORTED_MODULE_0__globals__["a" /* $window */],
	set(newContainer) {
		const eventsActive = __WEBPACK_IMPORTED_MODULE_1__events__["a" /* default */].active();
		if (eventsActive) {
			__WEBPACK_IMPORTED_MODULE_1__events__["a" /* default */].remove();
		}
		container.element = newContainer;
		if (eventsActive) {
			__WEBPACK_IMPORTED_MODULE_1__events__["a" /* default */].add();
		}
	},
	calculateScroll() {
		viewport.scroll.lastX = viewport.scroll.x;
		viewport.scroll.lastY = viewport.scroll.y;
		if (container.element === __WEBPACK_IMPORTED_MODULE_0__globals__["a" /* $window */]) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__globals__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__viewport__ = __webpack_require__(2);
 ...
 */
/* harmony default export */ __webpack_exports__["a"] = ((forceAll = false) => {
	for (let i = __WEBPACK_IMPORTED_MODULE_0__globals__["c" /* trackList */].length - 1; i >= 0; i--) {
		const item = __WEBPACK_IMPORTED_MODULE_0__globals__["c" /* trackList */][i];
		if (typeof item.callback === 'function') {
			const scrolled = (typeof item.config.calculateScrolled === 'function')
				? item.config.calculateScrolled(item.dimensions, __WEBPACK_IMPORTED_MODULE_1__viewport__["b" /* viewport */])
				: calculateScrolled(item.dimensions, __WEBPACK_IMPORTED_MODULE_1__viewport__["b" /* viewport */]);
			...
			if (!forceAll) {
				if (typeof item.config.shouldRedraw !== 'undefined') {
					if (typeof item.config.shouldRedraw === 'function') {
						initiateCallback = item.config.shouldRedraw(item.dimensions, __WEBPACK_IMPORTED_MODULE_1__viewport__["b" /* viewport */]);
					} else {
						initiateCallback = Boolean(item.config.shouldRedraw);
					}
				} else {
					initiateCallback = shouldRedraw(item.dimensions, __WEBPACK_IMPORTED_MODULE_1__viewport__["b" /* viewport */]);
				}
			}
			...
			if (initiateCallback) {
				item.callback(
					scrolled,
					item.dimensions,
					__WEBPACK_IMPORTED_MODULE_1__viewport__["b" /* viewport */]);
			}
		}
	}
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__globals__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__viewport__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dimensions__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__redraw__ = __webpack_require__(6);
...
if (!__WEBPACK_IMPORTED_MODULE_0__globals__["b" /* isServer */]) {
...
const recalculateItems = (list, view) => {
	for (let i = list.length - 1; i >= 0; i--) {
		const item = list[i];
		item.dimensions = Object(__WEBPACK_IMPORTED_MODULE_2__dimensions__["a" /* default */])(
	...
	Object(__WEBPACK_IMPORTED_MODULE_3__redraw__["a" /* default */])(true);
};
 ...
 */
/* harmony default export */ __webpack_exports__["a"] = ((element, immediate = false) => {
	...
	for (let i = __WEBPACK_IMPORTED_MODULE_0__globals__["c" /* trackList */].length - 1; i >= 0; i--) {
		...
		if (!element) {
			recalculateList = __WEBPACK_IMPORTED_MODULE_0__globals__["c" /* trackList */];
			break;
		}
	...
	if (!recalculatePending && !immediate && !element) {
		...
		rAF(() => {
			recalculateItems(recalculateList, __WEBPACK_IMPORTED_MODULE_1__viewport__["b" /* viewport */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__globals__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__redraw__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recalculate__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__viewport__ = __webpack_require__(2);
...
if (!__WEBPACK_IMPORTED_MODULE_0__globals__["b" /* isServer */]) {
	events.push({
		target: () => __WEBPACK_IMPORTED_MODULE_3__viewport__["a" /* container */].element,
		name: 'scroll',
		callback: () => {
			__WEBPACK_IMPORTED_MODULE_3__viewport__["a" /* container */].calculateScroll();
			Object(__WEBPACK_IMPORTED_MODULE_1__redraw__["a" /* default */])();
		},
	});
	...
	events.push({
		...
		name: 'resize',
		callback: () => {
			__WEBPACK_IMPORTED_MODULE_3__viewport__["a" /* container */].calculateDimensions();
			...
			Object(__WEBPACK_IMPORTED_MODULE_2__recalculate__["a" /* default */])();
		},
	});
}
/**
...
/* harmony default export */ __webpack_exports__["a"] = ((rect, view) => ({
...
var _SkyReveal = __webpack_require__(55);

var _SkyReveal2 = _interopRequireDefault(_SkyReveal);

var _SkyRevealTrigger = __webpack_require__(93);

var _SkyRevealTrigger2 = _interopRequireDefault(_SkyRevealTrigger);
...
Component.options.__file = "/Users/rudiornhoj/Sites/roernhoej/sky-reveal/src/SkyReveal.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] SkyReveal.vue: functional components are not supported with templates, they should use render functions.")}
...
__webpack_require__(59)("51f02bb4", content, false);
...
var _revealer = __webpack_require__(62);
...
exports.default = {
	...
	computed: {
		revealStates: function revealStates() {
	...
	mounted: function mounted() {
		...
		this.revealer = (0, _revealer2.default)(this.$refs.main, this.$refs.inner);
		...
		this.$nextTick(function () {
			_this.activeToggle = true;
		});
	},
	updated: function updated() {
		if (this.activeToggle) {
			this.showContent ? this.revealer.open() : this.revealer.close();
		}
	}
};
...
var _heightCalculator = __webpack_require__(63);

var _heightCalculator2 = _interopRequireDefault(_heightCalculator);

var _animeInstance = __webpack_require__(64);

var _animeInstance2 = _interopRequireDefault(_animeInstance);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = function (target, innerTarget) {
	if (typeof window !== 'undefined' && target && innerTarget) {
		var collapsed = window.getComputedStyle(target).minHeight || 0;
		var anim = (0, _animeInstance2.default)(target, collapsed, (0, _heightCalculator2.default)(target, innerTarget));

		var reInstantiate = function reInstantiate() {
			anim = (0, _animeInstance2.default)(target, collapsed, (0, _heightCalculator2.default)(target, innerTarget));
		};

		var open = function open() {
			if (anim.reversed) {
				if (anim.animations[0].tweens[0].value[1] !== (0, _heightCalculator2.default)(target, innerTarget)) {
					reInstantiate();
				}
				anim.play();
				anim.reverse();
...
exports.default = function (target, collapsed, autoHeight) {
	var duration = 500;
	...
	return (0, _animejs2.default)({
		...
		direction: 'reverse',
		complete: function complete(self) {
			if (!self.reversed) {
				target.removeAttribute('style');
			}

			_skyScroll2.default.recalculate();
...
var _animejs = __webpack_require__(65);

var _animejs2 = _interopRequireDefault(_animejs);

var _skyScroll = __webpack_require__(66);

var _skyScroll2 = _interopRequireDefault(_skyScroll);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sky_scroll__ = __webpack_require__(67);


/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__sky_scroll__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_core_js_fn_array_find_index__ = __webpack_require__(68);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__factories_globals__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__factories_recalculate__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__factories_tracking__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__factories_redraw__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__factories_viewport__ = __webpack_require__(2);
...
if (!__WEBPACK_IMPORTED_MODULE_1__factories_globals__["b" /* isServer */]) {
	__WEBPACK_IMPORTED_MODULE_5__factories_viewport__["a" /* container */].calculateDimensions();
	__WEBPACK_IMPORTED_MODULE_5__factories_viewport__["a" /* container */].calculateScroll();
	window.onload = () => {
		Object(__WEBPACK_IMPORTED_MODULE_2__factories_recalculate__["a" /* default */])();
	};
	window.onload();
}

/* harmony default export */ __webpack_exports__["a"] = ({
	viewport: __WEBPACK_IMPORTED_MODULE_5__factories_viewport__["b" /* viewport */],
	on: __WEBPACK_IMPORTED_MODULE_3__factories_tracking__["b" /* on */],
	off: __WEBPACK_IMPORTED_MODULE_3__factories_tracking__["a" /* off */],
	track: __WEBPACK_IMPORTED_MODULE_3__factories_tracking__["c" /* track */],
	untrack: __WEBPACK_IMPORTED_MODULE_3__factories_tracking__["d" /* untrack */],
	recalculate: __WEBPACK_IMPORTED_MODULE_2__factories_recalculate__["a" /* default */],
	redraw: __WEBPACK_IMPORTED_MODULE_4__factories_redraw__["a" /* default */],
	setContainer: __WEBPACK_IMPORTED_MODULE_5__factories_viewport__["a" /* container */].set,
});
...
module.exports = __webpack_require__(10).Array.findIndex;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return untrack; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__redraw__ = __webpack_require__(6);
...
const track = (element, callback, config = {}) => {
	...
	__WEBPACK_IMPORTED_MODULE_0__globals__["c" /* trackList */].push({
		element,
		dimensions: Object.assign({}, Object(__WEBPACK_IMPORTED_MODULE_2__dimensions__["a" /* default */])(rect, __WEBPACK_IMPORTED_MODULE_1__viewport__["b" /* viewport */])),
		callback,
		config,
	});

	if (__WEBPACK_IMPORTED_MODULE_0__globals__["c" /* trackList */].length === 1) {
		__WEBPACK_IMPORTED_MODULE_3__events__["a" /* default */].add();
	}
	Object(__WEBPACK_IMPORTED_MODULE_4__redraw__["a" /* default */])();
};
...
const untrack = (element, callback) => {
	...
	for (let i = __WEBPACK_IMPORTED_MODULE_0__globals__["c" /* trackList */].length - 1; i >= 0; i--) {
		...
		if (item.element === element) {
			if (callbackNotAFunction) {
				__WEBPACK_IMPORTED_MODULE_0__globals__["c" /* trackList */].splice(i, 1);
	...
	if (__WEBPACK_IMPORTED_MODULE_0__globals__["c" /* trackList */].length === 0) {
		__WEBPACK_IMPORTED_MODULE_3__events__["a" /* default */].remove();
	}
};
...
Component.options.__file = "/Users/rudiornhoj/Sites/roernhoej/sky-reveal/src/SkyRevealTrigger.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] SkyRevealTrigger.vue: functional components are not supported with templates, they should use render functions.")}
...
exports.default = {
	...
	computed: {
		isOpen: function isOpen() {
			var getterFn = this.$store.getters['SkyReveal/revealStates'];
	...
	created: function created() {
		var register = this.$store.state['SkyReveal'] && this.$store.state['SkyReveal'][this.revealId] === undefined;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('button', {
    class: ['sky-reveal-trigger', {
      open: _vm.isOpen
    }],
    on: {
      "click": _vm.toggle
    }
  }, [_vm._t("svg"), _vm._v(" "), _vm._t("svg-prepend"), _vm._v(" "), (!_vm.isOpen) ? _vm._t("open") : _vm._t("closed"), _vm._v(" "), _vm._t("svg-append")], 2)
},staticRenderFns: []}
module.exports.render._withStripped = true
...
var _state = __webpack_require__(97);
...
var _mutations = __webpack_require__(100);
...
var getters = {
	revealStates: function revealStates(state) {
		return function (key) {
...
var mutations = {
	REGISTER: function REGISTER(state, payload) {
		(0, _keys2.default)(payload).forEach(function (key) {
			...
			_vue2.default.set(state, key, payload[key]);
		});
	},
	UNREGISTER: function UNREGISTER(state, id) {
		if (id in state) {
			_vue2.default.delete(state, id);
		} else {
